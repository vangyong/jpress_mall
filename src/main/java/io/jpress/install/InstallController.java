		...
		try {
			...
			if (null != tableList && tableList.size() > 0) {
				if (tableList.contains(db_table_prefix + "attachment")
						...
						|| tableList.contains(db_table_prefix + "spec")
						|| tableList.contains(db_table_prefix + "spec_value")
						|| tableList.contains(db_table_prefix + "content_spec_item")
						|| tableList.contains(db_table_prefix + "shopping_cart")
						|| tableList.contains(db_table_prefix + "user_address")
						|| tableList.contains(db_table_prefix + "transaction")
						|| tableList.contains(db_table_prefix + "transaction_item"))
				{ // table
				  // has
				  // contains
