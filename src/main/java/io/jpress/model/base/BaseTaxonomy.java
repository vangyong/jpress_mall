...
public abstract class BaseTaxonomy<M extends BaseTaxonomy<M>> extends JModel<M> implements IBean {
	...
	public static final String METADATA_TYPE_BANNER = "taxonomy_banner";
	...
	public static final String ACTION_ADDORUPDATE = "taxonomy:saveOrUpdate";
	...
	public Metadata createMetadata(String type){
		...
		md.setObjectType(type);
		return md;
	}

	public Metadata createMetadata(String type, String key,String value){
		Metadata md = new Metadata();
		md.setObjectId(getId());
		md.setObjectType(type);
		md.setMetaKey(key);
	...
	public boolean saveOrUpdateMetadta(String type, String key,String value){
		Metadata metadata = MetaDataQuery.me().findByTypeAndIdAndKey(type, getId(), key);
		if (metadata == null) {
			metadata = createMetadata(type, key, value);
	...
	public String metadata(String type, String key) {
		Metadata m = MetaDataQuery.me().findByTypeAndIdAndKey(type, getId(), key);
		if (m != null) {
