...
public abstract class BaseVerifyCode<M extends BaseVerifyCode<M>> extends JModel<M> implements IBean {

	public static final String CACHE_NAME = "verifyCode";
	public static final String METADATA_TYPE = "verifyCode";

	public static final String ACTION_ADD = "verifyCode:add";
	public static final String ACTION_DELETE = "verifyCode:delete";
	public static final String ACTION_UPDATE = "verifyCode:update";
	...
	public boolean equals(Object o) {
		...
		if(!(o instanceof BaseVerifyCode<?>)){return false;}

		BaseVerifyCode<?> m = (BaseVerifyCode<?>) o;
